...
def main():
    ...
    trainFeaturePath = 'C:/Users/paupi/Documentos/Projeto_Python_Codigo_Completo_Extrac_Classif_Classico/classificacao/features_labels/haralick/train/'
    testFeaturePath = 'C:/Users/paupi/Documentos/Projeto_Python_Codigo_Completo_Extrac_Classif_Classico/classificacao/features_labels/haralick/test/'
...
def extractHaralickFeatures(images):
    bar = Bar('[INFO] Extracting Haralick features...', max=len(images), suffix='%(index)d/%(max)d  Duration:%(elapsed)ds')
    featuresList = []
    for image in images:
