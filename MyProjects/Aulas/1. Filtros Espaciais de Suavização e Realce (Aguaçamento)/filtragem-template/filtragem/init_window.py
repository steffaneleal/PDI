...
class Window(tk.Tk):
    ...
    def create_filter_menu(self):
        ...
        sharpen_menu.add_command(label='Sobel', command=self.create_sobel_filter_controls)
    ...
    def create_sobel_filter_controls(self):
        self.clear_control_frame()
        button = tk.Button(self.controls, text='Aplicar', command=self.apply_sobel_filter,width=20,height=1)
        button.pack(side=tk.LEFT) 
        self.remove_button = tk.Button(self.controls, text='Remover Filtros', command=self.remove_filters,width=20,height=1)
    ...
    def apply_sobel_filter(self):
        self.image = filtering.sobel_filter(self.image)
        self.remove_button.pack(side=tk.LEFT,padx=5)
        self.display_image()             
